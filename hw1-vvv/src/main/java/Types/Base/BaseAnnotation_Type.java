...
public class BaseAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("Types.Base.BaseAnnotation");
  ...
  public String getCasProcessorId(int addr) {
      ...
      jcas.throwFeatMissing("CasProcessorId", "Types.Base.BaseAnnotation");
  ...
  public float getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("Confidence", "Types.Base.BaseAnnotation");
